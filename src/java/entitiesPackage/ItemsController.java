...
import entitiesPackage.util.JsfUtil;
import entitiesPackage.util.PaginationHelper;
...
public class ItemsController implements Serializable {
    ...
    @EJB
    private entitiesPackage.ItemsFacade ejbFacade;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ItemsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
